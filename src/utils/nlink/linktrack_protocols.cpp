...
NLT_ProtocolAnchorFrame0::NLT_ProtocolAnchorFrame0()
  : NProtocolBase(true, nltAnchorFrame0_.kFixedFrameLength,
                  { nltAnchorFrame0_.kFrameHeader, nltAnchorFrame0_.kFunctionMark }, { nltAnchorFrame0_.kTailCheck })
{
}
...
NLT_ProtocolTagFrame0::NLT_ProtocolTagFrame0()
  : NProtocolBase(true, nltTagFrame0_.kFixedFrameLength, { nltTagFrame0_.kFrameHeader, nltTagFrame0_.kFunctionMark })
{
}
...
NLT_ProtocolNodeFrame0::NLT_ProtocolNodeFrame0()
  : NLT_ProtocolNodeFrameBase(true, nltNodeFrame0_.kFixedFrameLength,
...
NLT_ProtocolNodeFrame1::NLT_ProtocolNodeFrame1()
  : NLT_ProtocolNodeFrameBase(true, nltNodeFrame1_.kFixedFrameLength,
...
NLT_ProtocolNodeFrame2::NLT_ProtocolNodeFrame2()
  : NLT_ProtocolNodeFrameBase(true, nltNodeFrame2_.kFixedFrameLength,
...
NLT_ProtocolNodeFrame3::NLT_ProtocolNodeFrame3()
  : NLT_ProtocolNodeFrameBase(true, nltNodeFrame3_.kFixedFrameLength,
...
bool NLT_ProtocolNodeFrameBase::updateLength(const uint8_t *data, size_t availableBytes)
{
  if (availableBytes < 4)
    return false;
...
NLTAoa_ProtocolNodeFrame0::NLTAoa_ProtocolNodeFrame0()
  : NLT_ProtocolNodeFrameBase(true, nltAoaNodeFrame0_.kFixedFrameLength,
                              { nltAoaNodeFrame0_.kFrameHeader, nltAoaNodeFrame0_.kFunctionMark })
{
}

void NLTAoa_ProtocolNodeFrame0::updateData(const uint8_t *data)
{
  nltAoaNodeFrame0_.unpackData(data, length());
}